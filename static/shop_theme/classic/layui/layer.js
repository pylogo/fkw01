...
;!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        var t = this;
        t.index = ++r.index, t.config = i.extend({}, t.config, o.config, e), r.ready(function () {
    ...
    l.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        function t(e) {
            e = s.find(e), e.height(f[1] - c - u - 2 * (0 | parseFloat(e.css("padding"))))
        }
